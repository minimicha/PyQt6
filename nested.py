...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        info_label = QLabel("Select 2 drinks for lunch, the amount fo each, and their prices.")
        info_label.setFont(QFont("Arial", 16))
        info_label.setAlignment(Qt.AlignmentFlag.AlignCenter)

        # Create a list of food items and two separate
        food_list = ["coffee","tea","vodka","water"]
        ...
        # Create two QSpinBox widgets to display amounts
        self.quantety_sb1 = QSpinBox()
        self.quantety_sb1.setRange(0, 5)
        self.quantety_sb1.valueChanged.connect(self.calculateTotal)

        self.quantety_sb2 = QSpinBox()
        self.quantety_sb2.setRange(0, 5)
        self.quantety_sb1.valueChanged.connect(self.calculateTotal)
    ...
    def calculateTotal(self, value):
        ...
        total = self.price_sb1.value() * self.quantety_sb1.value() + self.price_sb2.value() * self.quantety_sb2.value()
